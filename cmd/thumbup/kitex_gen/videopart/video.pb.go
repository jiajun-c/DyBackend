...
import (
	...
	userpart "tiktok/cmd/thumbup/kitex_gen/userpart"
)
...
type Video struct {
	...
	Author        *userpart.User `protobuf:"bytes,2,opt,name=author,proto3" json:"author,omitempty"`                                     //视频作者信息
...
func (x *Video) GetAuthor() *userpart.User {
	if x != nil {
		return x.Author
	}
	return nil
...
func (x *FeedRresponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FeedRresponse) ProtoMessage() {}

func (x *FeedRresponse) ProtoReflect() protoreflect.Message {
	mi := &file_video_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FeedRresponse.ProtoReflect.Descriptor instead.
func (*FeedRresponse) Descriptor() ([]byte, []int) {
	return file_video_proto_rawDescGZIP(), []int{2}
}

func (x *FeedRresponse) GetBaseResp() *base.BaseResponse {
	if x != nil {
		return x.BaseResp
	}
	return nil
...
func (x *FeedRresponse) GetVideoList() []*Video {
	if x != nil {
		return x.VideoList
	}
	return nil
...
func (x *FeedRresponse) GetNextTime() int64 {
	if x != nil {
		return x.NextTime
	}
	return 0
...
type DoPublishActionRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *DoPublishActionRequest) Reset() {
	*x = DoPublishActionRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *DoPublishActionRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DoPublishActionRequest) ProtoMessage() {}

func (x *DoPublishActionRequest) ProtoReflect() protoreflect.Message {
	mi := &file_video_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DoPublishActionRequest.ProtoReflect.Descriptor instead.
func (*DoPublishActionRequest) Descriptor() ([]byte, []int) {
	return file_video_proto_rawDescGZIP(), []int{3}
}

func (x *DoPublishActionRequest) GetData() []byte {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *DoPublishActionRequest) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
type DoPublishActionResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *DoPublishActionResponse) Reset() {
	*x = DoPublishActionResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *DoPublishActionResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DoPublishActionResponse) ProtoMessage() {}

func (x *DoPublishActionResponse) ProtoReflect() protoreflect.Message {
	mi := &file_video_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DoPublishActionResponse.ProtoReflect.Descriptor instead.
func (*DoPublishActionResponse) Descriptor() ([]byte, []int) {
	return file_video_proto_rawDescGZIP(), []int{4}
}

func (x *DoPublishActionResponse) GetBaseResp() *base.BaseResponse {
	if x != nil {
		return x.BaseResp
	}
	return nil
...
func (x *GetPublishListResponse) GetBaseResp() *base.BaseResponse {
	if x != nil {
		return x.BaseResp
	}
	return nil
...
var file_video_proto_rawDesc = []byte{
	...
	0x69, 0x64, 0x65, 0x6f, 0x1a, 0x0a, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x1a, 0x0a, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf6, 0x01, 0x0a,
	...
	0x74, 0x69, 0x74, 0x6c, 0x65, 0x22, 0x2e, 0x0a, 0x0b, 0x46, 0x65, 0x65, 0x64, 0x52, 0x65, 0x71,
	...
	0x74, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x8a, 0x01, 0x0a, 0x0d, 0x46, 0x65, 0x65, 0x64, 0x52, 0x72,
	...
	0x6d, 0x65, 0x22, 0x42, 0x0a, 0x16, 0x44, 0x6f, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x41,
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04,
	0x64, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61,
	0x12, 0x14, 0x0a, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x22, 0x4a, 0x0a, 0x17, 0x44, 0x6f, 0x50, 0x75, 0x62, 0x6c,
	...
	0x73, 0x70, 0x22, 0x76, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68,
	...
	0x6e, 0x73, 0x65, 0x52, 0x08, 0x62, 0x61, 0x73, 0x65, 0x52, 0x65, 0x73, 0x70, 0x12, 0x2b, 0x0a,
	...
	,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x28, 0x5a, 0x26, 0x74, 0x69, 0x6b, 0x74, 0x6f, 0x6b,
	0x2f, 0x63, 0x6d, 0x64, 0x2f, 0x74, 0x68, 0x75, 0x6d, 0x62, 0x75, 0x70, 0x2f, 0x6b, 0x69, 0x74,
	0x65, 0x78, 0x5f, 0x67, 0x65, 0x6e, 0x2f, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x70, 0x61, 0x72, 0x74,
...
var file_video_proto_goTypes = []interface{}{
	...
	(*FeedRresponse)(nil),           // 2: video.FeedRresponse
	(*DoPublishActionRequest)(nil),  // 3: video.DoPublishActionRequest
	(*DoPublishActionResponse)(nil), // 4: video.DoPublishActionResponse
	(*GetPublishListResponse)(nil),  // 5: video.GetPublishListResponse
	(*GetPublishListRequest)(nil),   // 6: video.GetPublishListRequest
	(*userpart.User)(nil),           // 7: user.User
	(*base.BaseResponse)(nil),       // 8: base.BaseResponse
}
var file_video_proto_depIdxs = []int32{
	7, // 0: video.Video.author:type_name -> user.User
	8, // 1: video.FeedRresponse.base_resp:type_name -> base.BaseResponse
	0, // 2: video.FeedRresponse.video_list:type_name -> video.Video
	8, // 3: video.DoPublishActionResponse.base_resp:type_name -> base.BaseResponse
	8, // 4: video.GetPublishListResponse.base_resp:type_name -> base.BaseResponse
	0, // 5: video.GetPublishListResponse.video_list:type_name -> video.Video
	1, // 6: video.VideoService.Feed:input_type -> video.FeedRequest
	3, // 7: video.VideoService.DoPublishAction:input_type -> video.DoPublishActionRequest
	6, // 8: video.VideoService.GetPublishList:input_type -> video.GetPublishListRequest
	2, // 9: video.VideoService.Feed:output_type -> video.FeedRresponse
	4, // 10: video.VideoService.DoPublishAction:output_type -> video.DoPublishActionResponse
	5, // 11: video.VideoService.GetPublishList:output_type -> video.GetPublishListResponse
...
func file_video_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_video_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DoPublishActionRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_video_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DoPublishActionResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type VideoService interface {
	Feed(ctx context.Context, req *FeedRequest) (res *FeedRresponse, err error)
	DoPublishAction(ctx context.Context, req *DoPublishActionRequest) (res *DoPublishActionResponse, err error)
