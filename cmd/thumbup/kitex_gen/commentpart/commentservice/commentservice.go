...
func NewServiceInfo() *kitex.ServiceInfo {
	...
	handlerType := (*commentpart.CommentService)(nil)
...
func commentActionHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(commentpart.CommentActionRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(commentpart.CommentService).CommentAction(ctx, req)
		if err != nil {
			return err
		}
	...
	case *CommentActionArgs:
		success, err := handler.(commentpart.CommentService).CommentAction(ctx, s.Req)
		if err != nil {
			return err
		}
...
func (p *CommentActionArgs) Unmarshal(in []byte) error {
	msg := new(commentpart.CommentActionRequest)
...
var CommentActionArgs_Req_DEFAULT *commentpart.CommentActionRequest

func (p *CommentActionArgs) GetReq() *commentpart.CommentActionRequest {
	if !p.IsSetReq() {
...
type CommentActionResult struct {
	Success *commentpart.CommentActionResponse
}

var CommentActionResult_Success_DEFAULT *commentpart.CommentActionResponse

func (p *CommentActionResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(commentpart.CommentActionResponse)
	}
...
func (p *CommentActionResult) Unmarshal(in []byte) error {
	msg := new(commentpart.CommentActionResponse)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *CommentActionResult) GetSuccess() *commentpart.CommentActionResponse {
	if !p.IsSetSuccess() {
...
func (p *CommentActionResult) SetSuccess(x interface{}) {
	p.Success = x.(*commentpart.CommentActionResponse)
}
...
func commentListHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(commentpart.CommentListRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(commentpart.CommentService).CommentList(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *CommentListArgs:
		success, err := handler.(commentpart.CommentService).CommentList(ctx, s.Req)
		if err != nil {
			return err
		}
...
func (p *CommentListArgs) Unmarshal(in []byte) error {
	msg := new(commentpart.CommentListRequest)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var CommentListArgs_Req_DEFAULT *commentpart.CommentListRequest

func (p *CommentListArgs) GetReq() *commentpart.CommentListRequest {
	if !p.IsSetReq() {
...
type CommentListResult struct {
	Success *commentpart.CommentListResponse
}

var CommentListResult_Success_DEFAULT *commentpart.CommentListResponse

func (p *CommentListResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(commentpart.CommentListResponse)
	}
	return p.Success.FastRead(buf, _type, number)
}
...
func (p *CommentListResult) Unmarshal(in []byte) error {
	msg := new(commentpart.CommentListResponse)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *CommentListResult) GetSuccess() *commentpart.CommentListResponse {
	if !p.IsSetSuccess() {
...
func (p *CommentListResult) SetSuccess(x interface{}) {
	p.Success = x.(*commentpart.CommentListResponse)
}
...
func (p *kClient) CommentAction(ctx context.Context, Req *commentpart.CommentActionRequest) (r *commentpart.CommentActionResponse, err error) {
...
func (p *kClient) CommentList(ctx context.Context, Req *commentpart.CommentListRequest) (r *commentpart.CommentListResponse, err error) {
